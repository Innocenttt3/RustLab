...
impl RGB {
    ...
    fn intensity(&mut self, intensity: f32){
        self.r = (intensity * self.r as f32) as u8;
        self.g = (intensity * self.g as f32) as u8;
        self.b = (intensity * self.b as f32) as u8;
    }
}
